...
4. 修改docker cgroup driver，因为kubelet 与 docker所使用的cgroup driver 不一致，因此需要修改docker 或者 kubelet的 cgroup driver我这里选择的是修改docker的cgroup driver, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDk1MTE5NDYsLTkyNjE5MzAwMCwxOT
U4NDQ2NTUyLC0xNzMyMTQ3MjE0LC0xNTQzOTM3NzE5LDIxMjEz
NDM2OTUsMjE4NzU4MzA3LDE1MTEwNjM2NDAsMjQ2MzI4NDI3XX
0=
-->