...
1.  list中增加元素的操作方法有append()、 insert() .  append方法是在尾部添加元素这种方式效率一般表较高，但是当list的空间大小不够用的时候append



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1NjY2ODAxLDU5OTQxNTIxNiwtMzQyNT
A5MTcyLDExMjg5NjMzMjQsLTU4NTM0MDAxNSwtMTYyMzY5NDMw
NCwxNjI1NTk5MjA2LDE4MDExMjQxMDYsLTEzODk5MDY3LC0xNj
