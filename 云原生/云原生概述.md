...
### [Orchestration & Management](https://landscape.cncf.io/guide#orchestration-management)（编排与管理）
 ...
 改层是属于云原生技术栈的最底层，这一层主要是对IT基础设施的管理。云原生应用是基于云环境的，因此在最底层就是云环境可能是很多台物理机或者是多个虚拟机，在或者是公有云上的虚拟机等等，在这层就提供了许多的软件项目来管理这些基础设施，主要的项目包括Ansible
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5MTY2NTE1MCwtMzMzNTQ2ODE1LC0xNz
