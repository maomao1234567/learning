...
### kube-scheduler
kube-scheduler组件的主要功能是根据调度算法，将待运行Pod调度到一个最适合的node（节点）上去执行。它监听api-server上的创建Pod的事件，然后将待分配节点列表默认是选择一个资源占用

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDU5NTk5NjIsLTc4ODc2ODU3MCwtOD
IxMDk4MTkzLC0yNjc3OTQzODksLTE1NzgwMzc3MzcsMjcxMTY1
NDg0LDYwMDAzNjM3MSwxMzI3NDAzMDE4LC0xNjY5ODgxMzk4LD
EwMDQ5NTk4MzQsLTE1MTgzOTg5MDIsLTgzNTUwMTQ0Miw5ODYx
NzYyNzNdfQ==
-->