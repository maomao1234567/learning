...
### kubelet 
kubelet组件是在工作节点上安装的，它的功能主要是管理机器的资源，以及与容器运行时进行交互调用容器接口进行容器的创建管理。kubelet会定时想apiserver请求报告节点的资源占用情况节点状态，以及pod

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTI3NTI2MSw1NzkxNTEzNzMsLTM1ND
