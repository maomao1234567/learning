...
### kube-scheduler
kube-scheduler组件的主要功能是根据调度算法，将待运行Pod调度到一个最适合的node（节点）上去执行。它监听api-server上的创建Pod的事件，然后将待分配节点列表通过硬件资源

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4ODc2ODU3MCwtODIxMDk4MTkzLC0yNj
c3OTQzODksLTE1NzgwMzc3MzcsMjcxMTY1NDg0LDYwMDAzNjM3
MSwxMzI3NDAzMDE4LC0xNjY5ODgxMzk4LDEwMDQ5NTk4MzQsLT
E1MTgzOTg5MDIsLTgzNTUwMTQ0Miw5ODYxNzYyNzNdfQ==
-->