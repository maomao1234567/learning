...
### kube-proxy
kube-proxy组件的功能是代理转发服务请求到真实pod上，在k8s里service是一个虚拟的IP地址，通过kube-proxy管理service到真实提供服务的entripoint去服务。kube-proxy通过Linux的user

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDkzOTEzNDQsNTc5MTUxMzczLC0zNT
